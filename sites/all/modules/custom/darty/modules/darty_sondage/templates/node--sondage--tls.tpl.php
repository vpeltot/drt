<div class='sondage-div <?php print ($node->already == 0 && $node->status_sondage == 1) ? 'form' : 'result'; ?>'>
  <div class="question" id='question_<?php print $nid; ?>'>
  ...
  <?php else: ?>
    <div class="reponses">
      ...
      <div class="info-wrapper">
        ...
        <div class='date'>
          <?php if ($node->already == 1 && $node->status_sondage == 1): ?>
            depuis le <?php print date('d/m/Y', $datedeb); ?>
          <?php else: ?>
            du <?php print date('d/m/Y', $datedeb); ?> au <?php print date('d/m/Y', $datefin); ?>
          <?php endif; ?>
        </div>
      </div>
    </div>
